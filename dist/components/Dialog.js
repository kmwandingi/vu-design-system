...
export function Dialog({ open, onOpenChange, children }) {
    ...
    return open ? createPortal(_jsx("div", { className: "fixed inset-0 z-50", children: children }), document.body) : null;
}
...
export function DialogContent({ className, children, ...props }) {
    return (_jsx("div", { className: cn('fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl border bg-background p-6 shadow-lg', className), ...props, children: children }));
}
